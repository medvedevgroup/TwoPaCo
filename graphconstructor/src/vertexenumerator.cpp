...
//		}
//
//		void WriteCanonicalRecord(DnaString posVertex, DnaString negVertex, char posExtend, char posPrev, std::vector<uint64_t> & buf)
//		{
//
//		}
//
...
//					}
//
//					DnaString posEdge(edgeLength - 1);
//					for (size_t j = 0; j < edgeLength - 1; j++)
//					{
//						posEdge.SetChar(j, task.str[j]);
//					}
//
...
//				RecordIterator veryBegin(candidate->begin(), capacity);				
...
//					{
//						boost::lock_guard<boost::mutex> guard(*outMutex);
//						out->insert(out->end(), icand.base.GetBody(), icand.base.GetBody() + icand.base.GetCapacity());
//					}
//					else
//					{
//						falsePositives++;
